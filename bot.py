...
VALID_BUS_WORDS = {
    ...
    "حيوان": {
        ...
        'ك': ["كلب", "كنغر", "كوالا", "كاتس"],
        'ل': ["أسد", "قمر", "ليمور", "لحيوي"],
        'م': ["ماعز", "معز", "تمساح", "نمر", "قندس"],
    ...
    "نبات": {
        'ا': ["اناناس", "ازهار", "ارز", "استاكوزا", "انجاص", "الوكا"],
        'ب': ["برتقال", "بصل", "بطاطس", "بامية", "بنادق", "بقدونس"],
        'ت': ["تفاح", "تمر", "تين", "ترمس", "توليب"],
        'ث': ["ثوم", "ثبار"],
        'ج': ["جزر", "جوز", "جوافة", "جرجير", "جريب فروت", "زنجبيل"],
        'ح': ["حلبة", "حمص", "حناء", "حبق", "حشيش"],
        'خ': ["خيار", "خس", "خوخ", "خردل", "خطمي"],
        'د': ["دراق", "دارصيني", "دخن"],
        'ذ': ["ذرة", "ذرق"],
        'ر': ["رمان", "ريحان", "روزماري", "راوند"],
        'ز': ["زيتون", "زعتر", "زعفران", "زنبق", "زهرة"],
        'س': ["سفار", "سبانخ", "سمسم", "سنوبر", "سريس"],
        'ش': ["شعير", "شمندر", "شيح", "شبت", "شوكولاتة"],
        'ص': ["صبار", "صندل", "صعتر"],
        'ض': ["ضريع"],
        'ط': ["طماطم", "طحلب", "طماطم"],
        'ظ': ["ظيان"],
        'ع': ["عنب", "عدس", "عناب", "عفص", "عاقول"],
        'غ': ["غار", "غاب", "غرقد"],
    ...
    "بلاد": {
        'ا': ["اردن", "امريكا", "اسبانيا", "المانيا", "ايطاليا", "امارات", "ايران", "اغريق"],
        'ب': ["بريطانيا", "برازيل", "بلجيكا", "بحرين", "بلغاريا", "باراغواي"],
        'ت': ["تركيا", "تونس", "تشاد", "تايوان", "تشيلي", "تايلاند"],
        'ث': ["ثيودسيا"],
        'ج': ["جزائر", "يابان", "جمهورية التشيك", "جيبوتي", "جامايكا"],
        'ح': ["حبشة", "حمودة"],
        'خ': ["خلجي"],
        'د': ["دانمارك", "دومينيكان", "دبي"],
        'ذ': ["ذمار"],
        'ر': ["روسيا", "رومانيا", "رواندا"],
        'ز': ["زيمبابوي", "زامبيا"],
        'س': ["سعودية", "سودان", "سوريا", "سويسرا", "سويد", "سنغال", "سنغافورة"],
        'ش': ["صين", "شيلي", "شمال مقدونيا"],
        'ص': ["صومال", "صربيا"],
        'ض': ["ضفة الغربية"],
        'ط': ["طاجيكستان", "طنجة"],
        'ظ': ["ظفار"],
        ...
        'ن': ["نرويج", "نمسا", "نيبال", "نيجيريا", "نيوزيلندا", "نكاراجوا"],
        'ه': ["هند", "هولندا", "هونج كونج"],
        'و': ["الولايات المتحدة", "ويلز", "واتيكان"],
        'ي': ["يمن", "يابان", "يونان"]
    }
}
